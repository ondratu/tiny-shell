...
#define WIDGET_COLOR_ENABLE     0xF3F3F3
...
#define WM_BTN_BG               0xf8f8f7
#define WM_BTN_BG_MO            0xF7F7F7        // mouse over
#define WM_BTN_B                1               // border
#define WM_BTN_BC               0xb6b6b3        // border color
#define WM_BTN_FG_ENE           0x2E3436        // color enable
#define WM_BNT_FG_DIS           0x8b8e8f        // color disable
